...
public class LineSegmentLineSegmentIntersectionCoverage {

    // Small epsilon used for double value comparison.
    private static final double EPS = 1e-7;

    // Used for manual instrumentation
    public static AdHoc instrumentation = new AdHoc(20);
    ...
    public static Pt[] lineSegmentLineSegmentIntersection(Pt p1, Pt p2, Pt p3, Pt p4) {
        ...
        if (!segmentsIntersect(p1, p2, p3, p4)) {
            branchID = 0;
            LineSegmentLineSegmentIntersectionCoverage.instrumentation.coverBranch(branchID);
        ...
        if (n == 2) {
            ...
            return new Pt[] {
                endpoints.get(0), endpoints.get(1)
            };
        } else {
            branchID = 7;
            LineSegmentLineSegmentIntersectionCoverage.instrumentation.coverBranch(branchID);
