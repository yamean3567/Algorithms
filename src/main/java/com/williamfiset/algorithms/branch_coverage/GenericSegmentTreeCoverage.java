...
public class GenericSegmentTreeCoverage {

  // Used for manual instrumentation
  public static AdHoc instrumentation = new AdHoc(30);
  ...
  public GenericSegmentTreeCoverage(
      long[] values,
  ...
  private static void productQueryMulUpdateExample() {
    ...
    GenericSegmentTreeCoverage st =
        new GenericSegmentTreeCoverage(v, SegmentCombinationFn.PRODUCT, RangeUpdateFn.MULTIPLICATION);
  ...
  private static void gcdQueryMulUpdateExample() {
    ...
    long[] v = {12, 24, 3, 4, -1};
    GenericSegmentTreeCoverage st =
        new GenericSegmentTreeCoverage(v, SegmentCombinationFn.GCD, RangeUpdateFn.MULTIPLICATION);
  ...
  private static void gcdQueryAssignUpdateExample() {
    ...
    GenericSegmentTreeCoverage st =
        new GenericSegmentTreeCoverage(v, SegmentCombinationFn.GCD, RangeUpdateFn.ASSIGN);
  ...
  private static void sumQuerySumUpdateExample() {
    ...
    long[] v = {2, 1, 3, 4, -1};
    GenericSegmentTreeCoverage st =
        new GenericSegmentTreeCoverage(v, SegmentCombinationFn.SUM, RangeUpdateFn.ADDITION);
